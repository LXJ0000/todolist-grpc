...
type UserServiceClient interface {
	Register(ctx context.Context, in *UserRequest, opts ...grpc.CallOption) (*UserDetailResponse, error)
...
func (c *userServiceClient) Register(ctx context.Context, in *UserRequest, opts ...grpc.CallOption) (*UserDetailResponse, error) {
...
func (UnimplementedUserServiceServer) Register(context.Context, *UserRequest) (*UserDetailResponse, error) {
